...
macro "Run_BigStitcher"{
	...
	run("Filter pairwise shifts ...", "select=file:" + project_filepath + " filter_by_link_quality min_r=0.7 max_r=1 max_shift_in_x=100 max_shift_in_y=100 max_shift_in_z=1 max_displacement=0");
